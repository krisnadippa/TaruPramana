...
data class Tanaman(
    ...
    @SerialName("nama_bali") val namaBali: String? = null,
    @SerialName("nama_inggris") val namaInggris: String? = null,
    @SerialName("deskripsi_tanaman") val deskripsiTanaman: String? = null,
    @SerialName("deskripsi_lengkap") val deskripsiLengkap: String? = null,
